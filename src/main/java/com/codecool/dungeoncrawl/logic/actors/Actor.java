...
public abstract class Actor implements Drawable {
    ...
    boolean canHeroMove(Cell nextCell) {
        ...
        if (nextCell.getObject() != null) return nextCell.getTileName().equals("wall") || nextCell.getObject().getTileName().equals("closed-door") || nextCell.getObject().getTileName().equals("tree");
